"""
Adapted from: https://github.com/mlfoundations/open_flamingo/blob/main/open_flamingo/train/data.py
"""
...
def get_webdataset(args, image_processor, epoch=0, floor=False):
...
def get_dataset_fn(dataset_type):
    if dataset_type == "webdataset":
        return get_webdataset
    else:
        raise ValueError(f"Unsupported dataset type: {dataset_type}")


def get_data(args, image_processor, dataset_type="webdataset", epoch=0):
    return get_dataset_fn(dataset_type)(
        args, image_processor=image_processor, epoch=epoch
    )